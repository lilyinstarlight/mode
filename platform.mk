...
CXXFLAGS=-std=c++17 -fvisibility=hidden -fsanitize=address -ggdb -Wall -Wpedantic -Wextra -Wshadow=local -Weffc++ -Werror -I $(VENDORDIR) -I $(VENDORDIR)/yaml-cpp/include -I $(VENDORDIR)/lua -I $(VENDORDIR)/sol3/single/include `sdl2-config --cflags`
...
CXXFLAGS=-std=c++17 -fvisibility=hidden -flto -O2 -DNDEBUG -Wall -Wpedantic -Wextra -Wshadow=local -Weffc++ -I $(VENDORDIR) -I $(VENDORDIR)/yaml-cpp/include -I $(VENDORDIR)/lua -I $(VENDORDIR)/sol3/single/include `sdl2-config --cflags`
...
CXXFLAGS=-std=c++17 -fvisibility=hidden -fsanitize=address,undefined -ggdb -Wall -Wpedantic -Wextra -Wshadow=local -Weffc++ -Werror -I $(VENDORDIR) -I $(VENDORDIR)/yaml-cpp/include -I $(VENDORDIR)/lua -I $(VENDORDIR)/sol3/single/include `sdl2-config --cflags`
...
CXXFLAGS=-std=c++17 -fvisibility=hidden -ggdb -mwindows -Wall -Wpedantic -Wextra -Wshadow=local -Weffc++ -Werror -I $(VENDORDIR) -I $(VENDORDIR)/yaml-cpp/include -I $(VENDORDIR)/lua -I $(VENDORDIR)/sol3/single/include `sdl2-config --cflags`
...
CXXFLAGS=-std=c++17 -fvisibility=hidden -flto -O2 -mwindows -DNDEBUG -Wall -Wpedantic -Wextra -Wshadow=local -Weffc++ -I $(VENDORDIR) -I $(VENDORDIR)/yaml-cpp/include -I $(VENDORDIR)/lua -I $(VENDORDIR)/sol3/single/include `sdl2-config --cflags`
...
CXXFLAGS=-std=c++17 -fvisibility=hidden -g -Wall -Wpedantic -Wextra -Wshadow=local -Weffc++ -Werror -I $(VENDORDIR) -I $(VENDORDIR)/yaml-cpp/include -I $(VENDORDIR)/lua -I $(VENDORDIR)/sol3/single/include `sdl2-config --cflags`
...
CXXFLAGS=-std=c++17 -fvisibility=hidden -DNDEBUG -Wall -Wpedantic -Wextra -Wshadow=local -Weffc++ -I $(VENDORDIR) -I $(VENDORDIR)/yaml-cpp/include -I $(VENDORDIR)/lua -I $(VENDORDIR)/sol3/single/include `sdl2-config --cflags`
