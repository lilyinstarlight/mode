...
sudo apt-get install -y curl autoconf automake cmake make gcc g++ imagemagick fcitx-libs-dev libasound2-dev libdbus-1-dev libegl1-mesa-dev libgl1-mesa-dev libgles2-mesa-dev libglu1-mesa-dev libibus-1.0-dev libpulse-dev libsamplerate0-dev libudev-dev libvulkan-dev libwayland-dev libx11-dev libxcursor-dev libxext-dev libxi-dev libxinerama-dev libxkbcommon-dev libxrandr-dev libxss-dev libxt-dev libxv-dev libxxf86vm-dev libjpeg-turbo8-dev libpng-dev libogg-dev libvorbis-dev libmpg123-dev libfreetype-dev
